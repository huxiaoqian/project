...
try:
    ...
    from model import Topic, WholeUserIdentification, AreaUserIdentification, BurstUserIdentification
except ImportError:
    print 'Warning: Not in web environment.'

from time_utils import ts2datetime, datetime2ts, window2time

from global_config import xapian_search_weibo as status_search, xapian_search_user as user_search
