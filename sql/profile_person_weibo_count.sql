...
--
-- Table structure for table `profile_person_weibo_count`
--

DROP TABLE IF EXISTS `profile_person_weibo_count`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `profile_person_weibo_count` (
...
-- Dump completed on 2014-01-18  0:04:28
