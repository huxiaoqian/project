# -*- coding: utf-8 -*-
"""
    Whole Sentiment Detection Tests in Moodlens
...
class WSDTestCase(unittest.TestCase):
    ...
    def tearDown(self):
        print 'whole sentiment detection test tear down'
