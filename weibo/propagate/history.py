...
def _all_history(status, module='propagate'):
...
def _search_history(topic, module='propagate'):
...
def _add_history(status, topic, start, end, db_date, range=Fifteenminutes, module='propagate'):
